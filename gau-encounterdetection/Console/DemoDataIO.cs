...
namespace EDApplication
{
    public class DemoDataIO
    {
        ...
        static GameStateGenerator generator;

        static ParseTaskSettings defaulttask = new ParseTaskSettings()
        {
            SrcPath = META_PATH,
            DestPath = META_PATH,
        ...
        {
            ParseDemoFile(demopath, defaulttask);
            ReadGamestateJSONFile(demopath, defaulttask);
        }
